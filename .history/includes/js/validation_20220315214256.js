function recruitid_validation() {
    'use strict';
    var recruitid_name = document.getElementById("recruitID");
    var recruitid_value = document.getElementById("recruitID").value;
    var recruitid_length = recruitid_value.length;
    if (recruitid_length < 7 || recruitid_length > 12) {
        document.getElementById('rid_err').innerHTML = 'Value must not be less than 7 characters and greater than 12 characters';
        recruitid_name.focus();
        document.getElementById('rid_err').style.color = "#FF0000";
    } else {
        document.getElementById('rid_err').innerHTML = 'Valid user id';
