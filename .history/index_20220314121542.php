                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form class="form-check" action="delete_record.php" method="post" id="delete_record_form">
                                            <input class ="btn" type="hidden" name="recruitID" value="<?php echo $recruit['recruitID']; ?>">
                                            <input class ="btn" type="hidden" name="categoryID" value="<?php echo $recruit['categoryID']; ?>">
