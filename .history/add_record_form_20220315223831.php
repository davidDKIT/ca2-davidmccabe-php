...
<div class="container">
  ...
  <p><a class="btn btn-dark" href="index.php">View Homepage</a></p>
    ...
    <div class="form-group">
      ...
      <input type= "text" class="form-control" id="exampleFormControlTextarea1" name="recruitName" rows="3"></li>
      <label for="exampleFormControlTextarea1">Job</label>
      <input class="form-control" id="exampleFormControlTextarea1" name="job" rows="3"></li>
