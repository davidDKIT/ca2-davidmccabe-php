                        ...
                        <?php foreach ($recruits as $recruit) : ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <form class="form-control" action="delete_record.php" method="post" id="delete_record_form">
                                    ...
                                    <td>
                                        <form class="form-control" action="edit_record_form.php" method="post" id="delete_record_form">
                                            <input type="hidden" name="record_id" value="<?php echo $recruit['recruitID']; ?>">
                                            <input type="hidden" name="category_id" value="<?php echo $recruit['categoryID']; ?>">
