...
$recruit_id = filter_input(INPUT_GET, 'recruit_id', FILTER_VALIDATE_INT);
$category_id = filter_input(INPUT_GET, 'category_id', FILTER_VALIDATE_INT);
$recruitName = filter_input(INPUT_GET, 'recruitName');
$job = filter_input(INPUT_GET, 'job');
$militaryExp = filter_input(INPUT_GET, 'militaryExp');
$bloodType = filter_input(INPUT_GET, 'bloodType');
// Validate inputs
