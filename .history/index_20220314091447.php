                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form class="form-check" action="delete_record.php" method="post" id="delete_record_form">
                                            <input type="hidden" name="record_id" value="<?php echo $recruit['recruitID']; ?>">
                                    ...
                                    <td>
                                        <form class="form-check" action="edit_record_form.php" method="post" id="delete_record_form">
                                            <input class ="btn-icon-split" type="hidden" name="record_id" value="<?php echo $recruit['recruitID']; ?>">
                                            <input class ="btn-icon-split"  type="hidden" name="category_id" value="<?php echo $recruit['categoryID']; ?>">
                                            <input class ="btn-icon-split"  type="submit" value="Edit">
                                        </form>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
