...
<div class="container">
  ...
  <form action="add_record.php" class="text-center method="post" enctype="multipart/form-data" id="add_record_form">
  <p><a class="btn btn-dark" href="index.php">View Homepage</a></p>
    ...
    <div class="form-group">
      ...
      <textarea class="form-control, text-center" id="exampleFormControlTextarea1" name="job" rows="3"></textarea>
      <label for="exampleFormControlSelect2">Blood Type:</label>
      <select multiple class="form-control, text-center" id="exampleFormControlSelect2" name="bloodType">
        <option>O</option>
      ...
      <select multiple class="form-control, text-center" id="exampleFormControlSelect2" name="militaryExp">
        <option>yes</option>
        <option>no</option>
      </select>
      <label>Image:</label>
